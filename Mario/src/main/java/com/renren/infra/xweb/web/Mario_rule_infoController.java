...
public class Mario_rule_infoController {
    ...
    public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
        ...
        Page<Mario_rule_info> mario_rule_infos = service.getMario_rule_info(searchParams, pageNumber, Const.PAGE_SIZE);
    ...
    public String create(@Valid Mario_rule_info newMario_rule_info, RedirectAttributes redirectAttributes) {
    	
    	ShiroUser user = (ShiroUser) SecurityUtils.getSubject().getPrincipal();
    	newMario_rule_info.setuser_id(accountService.findUserByLoginName(user.loginName).getId());
    ...
    public String updateForm( @PathVariable("id") Integer id, Model model) {
    	...
    	Mario_zk_info mario_zk_info = zkInfoService.getMario_zk_info(mario_rule_info.getZk_id());
    ...
    public String update(@Valid @ModelAttribute("preloadMario_rule_info") Mario_rule_info mario_rule_info,
    ...
    public Mario_rule_info getMario_rule_info( @RequestParam(value = "id", required = false) Integer id) {
        if (id != null) {
