...
public class Mario_node_state {
    ...
    */
	...
	public String getctime() {
		return getctime("yyyy-MM-dd HH:mm:ss");
	}

	public String getctime(String pattern) {
		return new SimpleDateFormat(pattern).format(new Date(ctime));
	}
