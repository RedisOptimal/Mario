...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "static/bootstrap-metronic/template_content/assets/css/themes/" + color + ".css");
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
                message: '<img src="static/bootstrap-metronic/template_content/assets/img/ajax-loading.gif" align="">',
